...
public class GarageController {
    ...
    @GetMapping("/garages")
    public GarageDto readGarage(@RequestParam(defaultValue = "1") int page, @RequestParam(defaultValue = "6") int perPage, @RequestParam(required = false, defaultValue = "") String nom, @RequestParam(required = false, defaultValue = "") String ville) {
